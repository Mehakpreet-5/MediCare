...
function About() {
  ...
  return (
    <div className='bg-orange-50'>
      ...
      <div className='flex flex-col lg:flex-row w-full lg:h-5/6 pb-5 space-x-24 justify-center md:ml-14'>
      ...
      <div className='h-96 greenn flex flex-col lg:flex-row  space-x-10'>
        <Image src={micro} alt="Dr overlay" className=" h-48 w-72 lg:h-5/6 lg:w-2/6 md:w-2/6 ml-10 md:ml-44 pt-16" priority
          data-aos="zoom-in" data-aos-delay="100" data-aos-easing="ease-in-out" data-aos-duration="700" />
        <div className='lg:mt-20 mt-5 ml-7 mr-44 lg:w-2/6' data-aos="fade-up" data-aos-delay="100" data-aos-easing="ease-in-out" data-aos-duration="700">
      ...
      <div className='mt-20 mb-10'>
        <h2 className='text-orange-300 font-serif text-2xl lg:ml-72 ml-16'>Top Services</h2>
